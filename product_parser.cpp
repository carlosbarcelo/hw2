...
{
    string cat = "book";
    Book* parsed = new Book(cat, prodName_, price_, qty_, isbn_, author_);
    return parsed;
}
...
{
    string cat = "clothing";
    Clothes* parsed = new Clothes(cat, prodName_, price_, qty_, brand_, size_);
    return parsed;
}
...
{
    string cat = "movie";
    Movie* parsed = new Movie(cat, prodName_, price_, qty_, rating_, genre_);
    return parsed;
}